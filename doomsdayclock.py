...
text = Label(master, text = "years").place(x=135,y=40)
monthbox = Spinbox(master, from_ = 1, to = 12)
monthbox.place(x=250,y=60)
text2 = Label(master, text = "months").place(x=135,y=60)
